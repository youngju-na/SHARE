...
from ..model.encoder.dust3r.inference import get_pred_pts3d, find_opt_scaling
from ..model.encoder.dust3r.utils.geometry import inv, geotrf, normalize_pointcloud
from ..model.encoder.dust3r.utils.geometry import get_joint_pointcloud_depth, get_joint_pointcloud_center_scale
...
class Regr3D (Criterion, MultiLoss):
    ...
    def get_all_pts3d(self, gt1, gt2, pred1, pred2, dist_clip=None):
        ...
        in_camera1 = inv(gt1['camera_pose']) #* world2cam
