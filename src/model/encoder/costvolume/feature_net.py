...
class Unet(nn.Module):
    def __init__(self, in_channels, base_channels, out_channels, norm_act=nn.BatchNorm2d):
        ...
        self.smooth0 = nn.Conv2d(base_channels*4, out_channels, 3, padding=1)
