...
from src.model.encoder.dust3r.utils.geometry import inv, geotrf
from src.model.encoder.dust3r.utils.device import to_numpy
from src.model.encoder.dust3r.utils.image import rgb
from src.model.encoder.dust3r.viz import SceneViz, segment_sky, auto_cam_size
from src.model.encoder.dust3r.optim_factory import adjust_learning_rate_by_lr

from src.model.encoder.dust3r.cloud_opt.commons import (edge_str, ALL_DISTS, NoGradParamDict, get_imshapes, signed_expm1, signed_log1p,
...
class BasePCOptimizer (nn.Module):
    ...
    def compute_global_alignment(self, init=None, niter_PnP=10, **kw):
        import cloud_opt.init_im_poses as init_fun
        if init is None:
            pass
