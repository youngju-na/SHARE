...
import numpy as np
import torch
from .general_utils import PILtoTorch, quaternion2rotmat, rotmat2quaternion
...
def loadCam(args, id, cam_info, resolution_scale, scene_scale, camera_lr):
    ...
    resized_mask = resize_image(cam_info.mask, resolution_scale)
    resized_mono = None if cam_info.mono is None else resize_image(cam_info.mono, resolution_scale)
