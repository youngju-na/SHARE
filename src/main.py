...
def train(cfg_dict: DictConfig):
    ...
    model_wrapper.dataset_cfg = cfg.dataset
    
    #! add load checkpoint with strict=False
    # if checkpoint_path is not None and cfg.allow_loose_ckpt:
    #     state_dict = torch.load(checkpoint_path)
    #     model_wrapper.encoder.load_state_dict(state_dict['state_dict'], strict=False)
